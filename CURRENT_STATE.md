...
- Аудит русской транскрипции всех 126 051 форм: данные корректны (расхождения — это шва и камац-катан, не ошибки).
...
- **Остаётся одна связка:** enrichment-крон всё ещё под планировщиком Hermes (не перенесён на отдельный планировщик).
